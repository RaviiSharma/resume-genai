...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    if (!trimmedJobDescription) {
      setErrorMessage(
        "Please provide the job description before generating your interview plan.",
      );
      return;
    }
    ...
    if (!resumeFile && !trimmedSelfDescription) {
      setErrorMessage(
        "Please upload a resume or add a quick self-description.",
      );
      return;
    }
    ...
    if (!data) {
      setErrorMessage(
        "We couldn't generate the interview plan. Please check your details and try again.",
      );
      return;
    }
    ...
    <div className="home-page">
      ...
      {reports.length === 0 && !loading ? (
        <section className="recent-reports recent-reports--empty">
          ...
          <p>
            No interview plans yet. Generate your first strategy to see it here.
          </p>
        </section>
      ) : (
        reports.length > 0 && (
